...
typedef AssetPickerViewerPageRouteBuilder<T> =
    AssetPickerViewerPageRoute<T> Function(Widget viewer);

/// Built a fade transition for the viewer.
/// 为预览器构造一个渐变的页面过渡动画
/// 
class AssetPickerViewerPageRoute<T> extends PageRoute<T> with CupertinoRouteTransitionMixin<T> {
  /// Creates a page route for use in an iOS designed app.
  ///
  /// The [builder], [maintainState], and [fullscreenDialog] arguments must not
  /// be null.
